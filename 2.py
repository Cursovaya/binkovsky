...
def relative_to_assets(path: str) -> Path:
    ...
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\solov\OneDrive\Документы\Курсовая\frame0")
...
class HotelBookingApp:
    ...
    def save_hotel(self, name, address, description, image_path, frame):
        ...
        if image_path:
            add_hotel_image(hotel_id, image_path)
        ...
        def edit_hotel(self, hotel_id):
            ...
            def save_changes():
                ...
                if image_path_var.get():
                    image_path = relative_to_assets(f"hotel_{hotel_id}.jpg")
        ...
        def save_changes():
            ...
            if image_path_var.get():
                ...
                add_hotel_image(hotel_id, image_path_var.get())
    ...
    def edit_room(self, room):
        ...
        def save_changes():
            ...
            if image_path_var.get():
                ...
                # Добавляем новую фотографию
                add_room_image(room[0], image_path_var.get())
        ...
        tk.Button(edit_room_frame, text="Сохранить изменения", command=save_changes).grid(row=4, column=0,
                                                                                          columnspan=3, pady=10)
    ...
    def save_room(self, hotel_id, number, description, price, image_path, frame):
        ...
        if image_path:
            add_room_image(room_id, image_path)
