...
# Пример изображений (замените на свои файлы)
image_1_base64 = encode_image_to_base64("C:/Users/USER/PycharmProjects/pythonProject8/build/assets/frame0/image_1.png")
entry_1_base64 = encode_image_to_base64("C:/Users/USER/PycharmProjects/pythonProject8/build/assets/frame0/entry_1.png")
entry_2_base64 = encode_image_to_base64("C:/Users/USER/PycharmProjects/pythonProject8/build/assets/frame0/entry_2.png")
button_1_base64 = encode_image_to_base64("C:/Users/USER/PycharmProjects/pythonProject8/build/assets/frame0/button_1.png")
button_2_base64 = encode_image_to_base64("C:/Users/USER/PycharmProjects/pythonProject8/build/assets/frame0/button_2.png")
button_3_base64 = encode_image_to_base64("C:/Users/USER/PycharmProjects/pythonProject8/build/assets/frame0/button_3.png")

# Функция для загрузки изображений из base64
...
def create_db():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS hotel_images
                 (id INTEGER PRIMARY KEY, hotel_id INTEGER, image_data TEXT,
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS room_images
                 (id INTEGER PRIMARY KEY, room_id INTEGER, image_data TEXT,
...
def add_hotel_image(hotel_id, image_data):
    conn = get_db_connection()
    c = conn.cursor()
    c.execute("INSERT INTO hotel_images (hotel_id, image_data) VALUES (?, ?)",
              (hotel_id, image_data))
    conn.commit()
    conn.close()
...
def get_hotel_images(hotel_id):
    conn = get_db_connection()
    c = conn.cursor()
    c.execute("SELECT image_data FROM hotel_images WHERE hotel_id = ?", (hotel_id,))
    images = c.fetchall()
    conn.close()
    return images
...
def add_room_image(room_id, image_data):
    conn = get_db_connection()
    c = conn.cursor()
    c.execute("INSERT INTO room_images (room_id, image_data) VALUES (?, ?)",
              (room_id, image_data))
    conn.commit()
    conn.close()
...
def get_room_images(room_id):
    conn = get_db_connection()
    c = conn.cursor()
    c.execute("SELECT image_data FROM room_images WHERE room_id = ?", (room_id,))
    images = c.fetchall()
    conn.close()
    return images
...
def get_all_bookings():
    conn = get_db_connection()
    c = conn.cursor()
    c.execute("SELECT b.id, u.first_name, u.last_name, u.middle_name, h.name, r.number, b.check_in, b.check_out, r.price FROM bookings b JOIN users u ON b.user_id = u.id JOIN rooms r ON b.room_id = r.id JOIN hotels h ON r.hotel_id = h.id")
    bookings = c.fetchall()
    conn.close()
    return bookings
...
class HotelBookingApp:
    def __init__(self, root):
        ...
        self.image_image_1 = load_image_from_base64(image_1_base64)
        ...
        self.entry_image_1 = load_image_from_base64(entry_1_base64)
        ...
        self.entry_image_2 = load_image_from_base64(entry_2_base64)
        ...
        self.button_image_1 = load_image_from_base64(button_1_base64)
        ...
        self.button_image_2 = load_image_from_base64(button_2_base64)
        ...
        # Кнопка "Регистрация"
        self.button_image_3 = load_image_from_base64(button_3_base64)
    ...
    def show_hotel_details(self, hotel):
        ...
        for i, image_data in enumerate(images):
            try:
                image = load_image_from_base64(image_data[0])
    ...
    def edit_hotel(self, hotel_id):
        ...
        def save_changes():
            ...
            if image_path_var.get():
                image_data = encode_image_to_base64(image_path_var.get())
                add_hotel_image(hotel_id, image_data)
            conn.commit()
            conn.close()
